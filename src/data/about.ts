  ...
  hopesTo: {
    ...
    goals: {
      es: [
        ...
        { text: "Su proyecto personal", done: false },
        { text: "Un proyecto open source", done: false },
      ...
      en: [
        ...
        { text: "A personal side-project", done: false },
        { text: "An open source project", done: false },
